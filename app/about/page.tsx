...
const failures = [
  {
    ...
    what: "An algorithmic reporting error caused 68.5 million transactions to go unreported over six years. The FCA found that the firm failed to identify and fix the failure for years.",
    why: "Model failure with no adequate monitoring or oversight. The algorithm ran unchecked. Documented governance and continuous monitoring would have caught this.",
    severity: "high",
  },
  {
    ...
    what: "The Apple Card credit algorithm repeatedly assigned significantly lower credit limits to women than men with comparable profiles. The issue went viral and attracted regulatory investigation.",
    why: "Consumer-facing credit AI with no documented bias testing or oversight. Goldman could not evidence fairness to regulators. Consumer Duty equivalent — the firm bears the responsibility.",
    severity: "high",
  },
  {
    firm: "Zillow Offers",
    ...
    penalty: "$880m+ loss — business unit shut down",
    icon: <DollarSign className="h-4 w-4" />,
    what: "Zillow's AI home-buying algorithm over-estimated home values at scale. The firm acquired thousands of homes at inflated prices, resulting in an $880m write-down and complete shutdown.",
    why: "Overreliance on a model without adequate human oversight, validation, or circuit-breakers. The AI was trusted to make consequential financial decisions without sufficient governance controls.",
    severity: "high",
  },
  {
    ...
    year: "2012",
    regulator: "SEC",
    penalty: "$12m fine — near-bankruptcy, emergency rescue required",
    icon: <AlertTriangle className="h-4 w-4" />,
    what: "A deployment error reactivated a legacy trading algorithm. In 45 minutes it executed millions of erroneous trades, creating a $440m loss and bringing the firm to the brink of insolvency.",
    why: "No deployment governance, no automated kill switch, no change management on the algorithm. A model risk framework — of the kind PRA SS1/23 now mandates — would have required documented controls and live monitoring.",
    severity: "critical",
  },
  {
    ...
    penalty: "Major public backlash + regulatory inquiry",
    icon: <Eye className="h-4 w-4" />,
    what: "Lemonade's CEO tweeted that the company used AI to analyse 'non-verbal cues' in claims videos. The tweet triggered immediate backlash over GDPR violations, biometric processing, and discriminatory profiling.",
    why: "Consumer-facing AI making claims decisions — processed without consent, without a DPIA, and without documented governance. Exactly the scenario FCA Consumer Duty and GDPR Article 22 address.",
    severity: "medium",
  },
  {
    firm: "iTutor Group",
    ...
    icon: <Gavel className="h-4 w-4" />,
    what: "iTutor's AI recruiting software was programmed to automatically reject applicants over 55 (women) and 60 (men). The EEOC brought the first formal enforcement action targeting employer AI in hiring.",
    why: "AI used for consequential employment decisions with no bias testing, no documentation, and no human review. UK equivalents exist under the Equality Act 2010.",
    severity: "medium",
  },
];
...
const regulatorySignals = [
  ...
  },
  {
    ...
    body: "Requires firms to identify, document, and provide redress for automated decisions with significant effects. ICO enforcement is increasing. DPIAs required for high-risk AI processing.",
  ...
  },
  {
    ...
    body: "Lloyd's syndicates and London Market underwriters are incorporating AI governance questions into PI and D&O renewal questionnaires. Firms without documented evidence face exclusions.",
  ...
  return (
    <>
        ...
        <Container>
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Link
                href="/assessment"
                className="inline-flex items-center gap-2 rounded-sm bg-blue-700 px-5 py-2.5 text-sm font-semibold text-white hover:bg-blue-800 transition-colors"
              >
                Run your assessment
      ...
      <div className="border-b border-slate-200 bg-white">
        <Container>
          <div className="grid divide-y sm:divide-y-0 sm:divide-x divide-slate-200 sm:grid-cols-4 text-center">
            {[
              { label: "Big Problem", body: "AI adoption outpacing governance" },
              { label: "Product", body: "Structured assessment & evidence tool" },
              { label: "First Wedge", body: "Insurance renewal & underwriting scrutiny" },
              { label: "Platform Vision", body: "Continuous governance & reassessment" },
            ].map((item) => (
      ...
      <section className="bg-slate-50 py-14 border-b border-slate-200">
        <Container>
          <div className="mx-auto max-w-4xl">
            ...
            <p className="mt-5 max-w-2xl text-base text-slate-600 leading-relaxed">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-3">
              {[
                { stat: "75%", label: "of UK financial firms using AI", source: "Bank of England, 2024" },
                { stat: "3 in 4", label: "firms lack documented AI governance frameworks", source: "FCA thematic review, 2023" },
                { stat: "£34.5m", label: "FCA fine for algorithmic failure — no monitoring in place", source: "FCA v Merrill Lynch, 2017" },
              ].map((s) => (
            ...
            <div className="mt-8 space-y-3">
              {[
                ...
                <div
                  key={item.title}
                  className="flex gap-4 rounded-sm border border-slate-200 bg-white p-5"
                >
              ...
              {regulatorySignals.map((r) => (
                <div key={r.label} className="rounded-sm border border-slate-200 bg-white p-5">
                  <div className="flex items-start justify-between mb-3 gap-2">
                    ...
                    <span
                      className={`rounded-sm px-2 py-0.5 text-xs font-medium shrink-0 ${r.urgencyColor}`}
                    >
                      {r.urgency}
                    </span>
                  </div>
        ...
        <Container>
          <div className="mx-auto max-w-4xl">
            ...
            <p className="mt-5 max-w-2xl text-base text-slate-600 leading-relaxed">
              ...
              for regulated firms. You answer questions about your AI system — decision authority,
              data handling, oversight controls, bias testing, incident history, and governance
              maturity. We produce a scored output and evidence pack.
            </p>
              ...
              {[
                {
                  ...
                  body: "A single scored output across five dimensions: Governance, Model Risk, Auditability, Human Oversight, and Operational Monitoring. Each rated, explained, and benchmarked against sector peers.",
                },
                {
                ...
                },
                {
                  ...
                  body: "A downloadable report structured to be shared directly with compliance teams, internal audit, underwriters, and board risk committees.",
                },
                {
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-sm font-bold text-slate-900">
                      Compliance or Risk Lead — mid-size regulated firm
                    </p>
                    <p className="mt-2 text-sm text-slate-600 leading-relaxed">
                      Head of Compliance, CRO, or Head of Model Risk at a firm between 50 and
                      300 employees. They know AI governance is a problem. They don&apos;t have
                      the budget for a Big Four engagement. They have a renewal conversation,
                      a board ask, or a regulator letter.
                    </p>
                    <p className="mt-2 text-sm text-slate-600 leading-relaxed">
                      They need something structured, fast, and credible — a scored assessment
                      with a clear action list they can put in front of their broker, auditor,
                      or board.
                    </p>
                    <div className="mt-4 grid gap-2 sm:grid-cols-3">
                      {[
                        { label: "Trigger", value: "Renewal, FCA letter, or board ask" },
                        { label: "Budget", value: "£2k–£10k per cycle" },
            ...
            <div className="mt-8 space-y-5">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="rounded-sm border border-slate-200 p-5">
                  ...
                  <ul className="space-y-2">
                    {[
                      "Firms don't complete the assessment — questions are too hard",
                      "The output isn't credible enough to use in a real conversation",
                      "Buyers already have this covered by their Big Four advisor",
              ...
              {[
                {
                  ...
                  body: "Structured 10-minute assessment, scored output across five dimensions, downloadable evidence pack. Free to run.",
                  active: true,
                },
                {
                  phase: "Next",
                ...
                <div
                  ...
                  className={`flex gap-4 rounded-sm border p-5 ${
                    item.active ? "border-blue-200 bg-blue-50" : "border-slate-200 bg-white"
                  }`}
                >
                  <div
                    className={`shrink-0 rounded-sm px-2 py-0.5 text-xs font-bold uppercase tracking-widest h-fit mt-0.5 ${
                      item.active ? "bg-blue-700 text-white" : "bg-slate-200 text-slate-500"
                    }`}
                  >
                    {item.phase}
                  </div>
